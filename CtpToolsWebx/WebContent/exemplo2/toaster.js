...
.service('toaster', ['$rootScope', 'toasterConfig', '$interval', function ($rootScope, toasterConfig, $interval) {
    ...
    {
      //do some things
      setTimeout(this.pop(), 10000) //wait ten seconds before continuing
    }
